      ...
      def wrapper_check( *args, **kwargs ):
        ...
        if not auth_active:
          ...
          if err_msg:
            ...
            return [ html.Div(children = err_msg, style = { "textAlign" : "center", "font-size" : "20px", "color" : "red" } ) ]
        
          else:
              
            return [ html.Div(children = [ dcc.Link( "Log in", href = "/startauth", refresh = True ) ], style = { "textAlign" : "center", "font-size" : "30px" } ) ]
        
        else:
            
          if not cls._user_has_a_role():
            return [html.Div(children = "Unauthorized!", style = { "textAlign" : "center", "font-size" : "20px", "color" : "red" } ) ]
